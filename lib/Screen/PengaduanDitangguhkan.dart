...
import 'DetailPengaduanDitangguhkan.dart';
import 'Detail_Memenuhi_IK.dart';

class PengaduanDitangguhkan extends StatefulWidget {
  @override
  _PengaduanDitangguhkanState createState() => _PengaduanDitangguhkanState();
}
...
class _PengaduanDitangguhkanState extends State<PengaduanDitangguhkan> {
  ...
  Future<List<Map<String, dynamic>>> getData() async {
    ...
    final res = await http.get(Uri.parse(url + "/api/showditangguhkanppk/" + id));
        ...
        itemBuilder: (context, int index) {
          return  _buildpengaduan(
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) {
                  return DetailPengaduanDitangguhkan(
