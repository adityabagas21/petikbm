...
class DetailTidakMemenuhiIK extends StatefulWidget {
  const DetailTidakMemenuhiIK(
      {Key key,
        this.koordinat_lat,
        this.koordinat_long,
        this.namaruas,
  ...
  @override
  _DetailTidakMemenuhiIKState createState() => _DetailTidakMemenuhiIKState();
...
class _DetailTidakMemenuhiIKState extends State<DetailTidakMemenuhiIK> {
