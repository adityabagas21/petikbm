...
class MemenuhiIK extends StatefulWidget {
  @override
  _MemenuhiIKState createState() => _MemenuhiIKState();
}
...
class _MemenuhiIKState extends State<MemenuhiIK> {
  ...
  Future<List<Map<String, dynamic>>> getData() async {
    ...
    final res = await http.get(Uri.parse(url + "/api/ikppk/" + id));
              ...
              MaterialPageRoute(
                builder: (context) {
                  return DetailMemenuhiIK(
                    ...
                    deskripsi_tanggapan: _posts[index]
                        ['identifikasi_tanggapan'],
                    koordinat_lat_tanggapan: _posts[index]
                        ['koordinat_lat_tanggapan'],
                    koordinat_long_tanggapan: _posts[index]
                        ['koordinat_long_tanggapan'],
